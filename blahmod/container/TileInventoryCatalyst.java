...
public class TileInventoryCatalyst extends TileEntity implements IInventory, ITickable {
	...
	public static final int RESULT_SLOTS_COUNT = 1;
	public static final int TOTAL_SLOTS_COUNT = CATALYST_SLOTS_COUNT + INPUT_SLOTS_COUNT + RESULT_SLOTS_COUNT;

	public static final int FIRST_FUEL_SLOT = 0;
	public static final int FIRST_INPUT_SLOT = FIRST_FUEL_SLOT + CATALYST_SLOTS_COUNT;
	...
	// Return true if the given stack is allowed to be inserted in the given slot
	// Unlike the vanilla furnace, we allow anything to be placed in the fuel slots
	static public boolean isItemValidForC2Slot(ItemStack itemStack)
	{
		return true;
	}
	...
	// Return true if the given stack is allowed to be inserted in the given slot
	// Unlike the vanilla furnace, we allow anything to be placed in the fuel slots
	static public boolean isItemValidForResultSlot(ItemStack itemStack)
	{
		return true;
	}
...
//		// Save the stored item stacks
	...
	public ItemStack getStackInSlotOnClosing(int arg0) {
		...
		if (itemStack != null) setInventorySlotContents(arg0, null);
		return itemStack;
	}

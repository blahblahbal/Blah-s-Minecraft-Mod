...
{
    private static final IBlockState log = ModBlocks.frostLog.getDefaultState().withProperty(ModBlockPalmLog.LOG_AXIS, EnumAxis.Y);
    private static final IBlockState leaves = ModBlocks.frostLeaves.getDefaultState().withProperty(BlockPalmLeaves.CHECK_DECAY, Boolean.valueOf(false)).withProperty(BlockPalmLeaves.DECAYABLE, Boolean.valueOf(true));
    public WorldGenFrostTree(boolean p_i45463_1_)
    {
        super(false);
    }
    public WorldGenFrostTree(World w, Random r, BlockPos bp)
    {
    	super(true);
    	generate(w, r, bp);
    }

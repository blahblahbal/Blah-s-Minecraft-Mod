...
public class ModBlockOre extends BlockOre {
    ...
    {
        if (this == ModBlocks.sulphurOre || this == ModBlocks.sulphurOre2) return ModItems.sulphur2;
        ...
        else if (this == ModBlocks.zirconOre) return ModItems.zircon;
        return this.drop;
    }
    ...
    public int getExpDrop(IBlockAccess world, BlockPos pos, int fortune)
    {
        ...
        if (this == ModBlocks.sulphurOre || this == ModBlocks.sulphurOre2)
        {

...
public final class ModBlocks
{
    ...
    public static ModBlockSlab[] woodSlabs = new ModBlockSlab[3];
    public static ModBlockSlab[] doubleWoodSlabs = new ModBlockSlab[3];
    ...
    public static void createBlocks()
    {
    	...
    	//GameRegistry.registerBlock(corePortal = new ModBlockPortal(), "corePortal");
    	...
    	doubleSlabs[0] = new ModBlockSlabDouble("double_woolSlab", Material.cloth);
    	doubleSlabs[1] = new ModBlockSlabDouble("double_ironSlab", Material.iron);
    	doubleSlabs[2] = new ModBlockSlabDouble("double_goldSlab", Material.iron);
    	doubleSlabs[3] = new ModBlockSlabDouble("double_diamondSlab", Material.iron);
    	doubleSlabs[4] = new ModBlockSlabDouble("double_emeraldSlab", Material.iron);
    	doubleSlabs[5] = new ModBlockSlabDouble("double_sulphurSlab", Material.iron);
    	doubleSlabs[6] = new ModBlockSlabDouble("double_limestoneSlab", Material.iron);
    	doubleSlabs[7] = new ModBlockSlabDouble("double_uraniumSlab", Material.iron);
    	...
    	doubleSlabs2[0] = new ModBlockSlabDouble("double_dirtSlab", Material.ground);
    	doubleSlabs2[1] = new ModBlockSlabDouble("double_grassSlab", Material.grass);
    	doubleSlabs2[2] = new ModBlockSlabDouble("double_leatherSlab", Material.cloth);
    	doubleSlabs2[3] = new ModBlockSlabDouble("double_lapisSlab", Material.iron);
    	doubleSlabs2[4] = new ModBlockSlabDouble("double_obsidianSlab", Material.rock);
    	doubleSlabs2[5] = new ModBlockSlabDouble("double_mossSlab", Material.rock);
    	doubleSlabs2[6] = new ModBlockSlabDouble("double_endStoneBrickSlab", Material.rock);
    	doubleSlabs2[7] = new ModBlockSlabDouble("double_tadaniteSlab", Material.iron);
    	...
    	doubleWoodSlabs[0] = new ModBlockSlabDouble("double_sequoiaSlab", Material.wood);
    	doubleWoodSlabs[1] = new ModBlockSlabDouble("double_palmSlab", Material.wood);
    	doubleWoodSlabs[2] = new ModBlockSlabDouble("double_cedarSlab", Material.wood);

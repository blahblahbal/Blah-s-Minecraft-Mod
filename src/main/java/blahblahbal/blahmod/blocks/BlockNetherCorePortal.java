...
import blahblahbal.blahmod.world.TeleporterNetherCore;
...
public class BlockNetherCorePortal extends BlockBreakable {
	...
	public BlockNetherCorePortal(String name)
	{
	...
	{
		BlockNetherCorePortal.Size blockportal$size = new BlockNetherCorePortal.Size(par1World, pos, EnumFacing.Axis.X);
		...
		{
			BlockNetherCorePortal.Size blockportal$size1 = new BlockNetherCorePortal.Size(par1World, pos, EnumFacing.Axis.Z);
	...
	public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock)
	{
		...
		if (enumfacing$axis == EnumFacing.Axis.X)
		{
			BlockNetherCorePortal.Size blockportal$size = new BlockNetherCorePortal.Size(worldIn, pos, EnumFacing.Axis.X);
		...
		{
			BlockNetherCorePortal.Size blockportal$size1 = new BlockNetherCorePortal.Size(worldIn, pos, EnumFacing.Axis.Z);
	...
	public void onEntityCollidedWithBlock(World par1World, BlockPos pos, IBlockState state, Entity par5Entity)
	{
		...
		if (par5Entity.ridingEntity == null && par5Entity.riddenByEntity == null && par5Entity instanceof EntityPlayerMP)
		{
			...
			else if (thePlayer.dimension != Config.netherCoreID)
			{
				thePlayer.timeUntilPortal = Config.portalCD;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, Config.netherCoreID, new TeleporterNetherCore(thePlayer.mcServer.worldServerForDimension(Config.netherCoreID), this, ModBlocks.netherIce));
			}
			else {
				thePlayer.timeUntilPortal = Config.portalCD;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, -1, new TeleporterNetherCore(thePlayer.mcServer.worldServerForDimension(-1), this, ModBlocks.netherIce));
			}
		}
	}
	...
	public static class Size
	{
		...
		protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_)
		{
			...
			for (i = 0; i < 22; ++i)
			{
				...
				if (!func_150857_a(world.getBlockState(blockpos).getBlock()) || world.getBlockState(blockpos.down()).getBlock() != ModBlocks.netherIce)
					break;
			}

			Block block = world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
			return block == ModBlocks.netherIce ? i : 0;
		}
			...
			label24:
				...
				for (field_150862_g = 0; field_150862_g < 21; ++field_150862_g)
					for (int i = 0; i < field_150868_h; ++i)
					{
						...
						if (block == ModBlocks.netherCorePortal)
							++field_150864_e;
		...
		for (int j = 0; j < field_150868_h; ++j)
			if (world.getBlockState(field_150861_f.offset(field_150866_c, j).up(field_150862_g)).getBlock() != ModBlocks.netherIce)
			{
				field_150862_g = 0;
				break;
			}
		...
		{
			return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == ModBlocks.iceFire || p_150857_1_ == ModBlocks.netherCorePortal;
		}
		...
		public void func_150859_c()
		{
			for (int i = 0; i < field_150868_h; ++i)
			{
				...
				for (int j = 0; j < field_150862_g; ++j)
					world.setBlockState(blockpos.up(j), ModBlocks.netherCorePortal.getDefaultState().withProperty(BlockPortal.AXIS, axis), 2);
			}
		}
	}
}